...
@Autonomous(name = "Right Auto", group = "Testing")
public class RightSide extends CameraOpMode {
...
//                .forward(48)
                .lineToSplineHeading(new Pose2d(64, 1, toRadians(90))) //-6
                .build();
...
//        telemetry.addData("finalY", poseEstimate.getY());1
