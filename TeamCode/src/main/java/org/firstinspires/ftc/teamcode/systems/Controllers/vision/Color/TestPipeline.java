package org.firstinspires.ftc.teamcode.systems.Controllers.vision.Color;
...
// Credits to team 7303 RoboAvatars, adjusted by team 3954 Pink to the FutureGreen

public class TestPipeline extends OpenCvPipeline {
    Scalar HOT_PINK = new Scalar(196, 23, 112);
    Scalar GREEN = new Scalar(44, 133, 62);
    ...
    // Green                                             Y      Cr     Cb
     public static Scalar GreenLower = new Scalar(0.0, 0.0, 0.0);
     public static Scalar GreenUpper = new Scalar(255.0, 120.0, 120.0);
    ...
    public TestPipeline(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
    ...
    public Mat detectColor(Mat Input) {
        Mat blurImg = new Mat();
