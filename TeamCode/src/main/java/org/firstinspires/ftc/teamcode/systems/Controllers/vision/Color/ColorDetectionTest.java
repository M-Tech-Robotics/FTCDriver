...
@Autonomous(name="ColorDetectionTest", group="Tutorials")
...
//    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 170.0, 120.0);
    ...
    public void runOpMode()
    {
        ...
        webcam.setPipeline(myPipeline = new TestPipeline(borderLeftX,borderRightX,borderTopY,borderBottomY));
    ...
    public void testing(TestPipeline myPipeline){
